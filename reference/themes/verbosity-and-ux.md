...
| 00058 | Add login alias for web QR and update docs/tests | 00:19 |
| 00065 | Show provider numbers in relay banner | 01:35 |
| 00068 | Silence Baileys session logs unless verbose | 01:40 |
| 00077 | feat: add config validation and send dry-run | 03:46 |
| 00079 | test: add infra coverage and fix web logging | 03:50 |
| 00081 | chore: route port error debug through logger | 03:51 |
| 00088 | chore: route exec logging through logger | 04:11 |
...
| 00095 | chore: add color to web auto-reply log | 04:42 |
| 00102 | chore: log web media sends | 05:09 |
| 00103 | chore: add connection/send logs and web error surfacing | 05:10 |
| 00117 | feat: add relay:tmux helper for relay watcher | 05:47 |
| 00120 | chore: attach when starting relay tmux session | 05:48 |
| 00122 | feat: add relay:tmux:attach to join existing session | 05:53 |
| 00125 | fix: keep MEDIA tokens with punctuation and log web media failures | 06:02 |
| 00128 | debug: log MEDIA extraction and parse Claude text for tokens | 06:14 |
| 00157 | CLI: drop web:login alias and simplify web quickstart | 12:30 |
| 00163 | CLI: add verbose flag to send and status | 12:43 |
| 00174 | docs: colorized help and example footer | 14:09 |
| 00203 | feat: keep typing indicators alive during commands | 00:05 |
| 00212 | Auto-reply: refresh typing indicator every 8s | 01:27 |
| 00213 | feat(web): add logout command and tests | 01:29 |
| 00216 | chore(auto-reply): include cwd in timeout message | 02:18 |
| 00221 | web: add heartbeat and bounded reconnect tuning | 02:34 |
| 00223 | web: add reconnect logging + troubleshooting doc | 02:41 |
| 00231 | chore: log heartbeat fallback and add test | 17:12 |
| 00232 | chore: log heartbeat session snapshot | 17:20 |
| 00233 | chore: add verbose heartbeat session logging | 17:21 |
| 00238 | CLI: rename heartbeat tmux helper and log file path | 18:00 |
| 00247 | Heartbeat: shorten prompt to token | 02:48 |
| 00252 | Update README.md | 18:14 |
| 00253 | Docs: link Clawd setup and current config | 18:17 |
| 00257 | Add Peekaboo and mcporter links to recommended tools | 18:26 |
| 00259 | Docs: mention Claude Code reuses existing subscription | 18:28 |
| 00260 | Docs: explain two-phone setup for dedicated AI number | 18:29 |
| 00261 | Docs: new Clawd session intro with personality and powers | 18:32 |
| 00262 | Docs: add useful CLI tools section (spotify-player, TTS, etc.) | 18:33 |
| 00264 | Add WhatsApp screenshot to claude-config.md | 18:43 |
| 00265 | Add gowa WhatsApp MCP to power user add-ons | 18:45 |
| 00267 | Release 1.2.0 | 18:52 |
| 00268 | Add browser-tools CLI and example tweets to docs | 18:59 |
| 00270 | Expand heartbeat capabilities in docs | 19:09 |
| 00271 | docs: Add Twitter automation and music recognition examples | 21:00 |
| 00277 | feat(heartbeat): allow manual message and dry-run for web/twilio | 08:14 |
| 00280 | feat: same-phone mode with echo detection and configurable marker | 04:50 |
| 00281 | Add samePhoneResponsePrefix config option | 05:24 |
| 00282 | Add timestampPrefix config for datetime awareness | 05:25 |
| 00283 | Generalize prefix config: messagePrefix + responsePrefix | 05:27 |
| 00284 | Simplify timestampPrefix: bool or timezone string, default true | 05:29 |
| 00294 | Document exclamation mark escaping workaround for Claude Code | 06:52 |
| 00295 | Add typing indicator after IPC send | 06:58 |
...
| 00350 | Verbose: send tool result metadata only | 09:40 |
...
| 00360 | Web: simplify logout message | 11:04 |
| 00366 | Add /restart WhatsApp command to restart warelay | 12:14 |
| 00368 | feat(web): add group chat mention support | 12:35 |
| 00371 | fix(web): allow group replies past allowFrom | 13:08 |
| 00376 | fix(web): annotate group replies with sender | 13:25 |
| 00379 | feat(web): prime group sessions with member roster | 13:33 |
...
| 00394 | CLI: add agent command for direct agent runs | 17:53 |
| 00408 | chore: redact long texts in web logs | 19:21 |
| 00415 | feat: add mac companion app | 23:13 |
| 00421 | fix: avoid echoing prompts when rpc returns empty | 22:52 |
| 00428 | chore: add mac build+run helper | 23:47 |
| 00429 | chore: bundle mac app and custom menu icon | 23:54 |
| 00430 | feat: richer mac settings panes and template icon | 23:59 |
| 00431 | feat(mac): animate menubar icon | 00:07 |
| 00432 | fix(mac): show critter menubar icon | 00:10 |
| 00433 | feat: trimmy-style settings tabs and CLI helper bundling | 00:11 |
| 00434 | chore: add settings shortcut and restart packaging | 00:14 |
| 00435 | chore: open settings from menu and restart packaged app | 00:15 |
| 00436 | fix(mac): align critter legs | 00:24 |
| 00437 | mac: polish onboarding and lifecycle | 00:37 |
| 00438 | mac: auto-show onboarding on first run | 00:40 |
| 00439 | mac: tighten settings layout | 00:42 |
| 00441 | mac: match trimmy about layout | 00:44 |
| 00442 | mac: lock settings window size | 00:46 |
| 00443 | feat(mac): add critter ear/leg wiggles | 00:49 |
| 00445 | mac: bring onboarding layout closer to vibetunnel | 00:50 |
| 00446 | mac: tighten onboarding card layout | 00:52 |
| 00447 | mac: trimmy-style padding and debug toggle | 00:55 |
| 00448 | mac: fix settings window size persistence | 00:56 |
| 00449 | fix(mac): dim menubar icon like trimmy | 01:07 |
| 00450 | chore(mac): rebuild and relaunch like trimmy | 01:15 |
| 00452 | chore(mac): label toggle as Clawdis Active | 01:17 |
| 00483 | gateway: return actionable error for send channel webchat | 12:31 |
