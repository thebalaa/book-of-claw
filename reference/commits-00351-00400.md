# Commit Reference: 00351–00400

A plain factual summary of every commit in the OpenClaw repository, from commit 351 through commit 400.

---

## 00351 — Verbose: include tool arg metadata in prefixes
**SHA:** 527bed2b53 · **Time:** 09:57
...
Extends tool result messages to include metadata (paths, commands) in the prefix. The tool result prefix now includes available details like file paths from read operations or bash commands. Test cases verify that metadata is correctly extracted and forwarded in the format `[🛠️ tool-name arg]`.

## 00352 — Verbose: batch rapid tool results
**SHA:** 38a03ff2c8 · **Time:** 10:11
**Files changed:** CHANGELOG.md, src/auto-reply/command-reply.ts, src/index.core.test.ts
**Tags:** `verbosity`, `auto-reply`, `core-feature`

Implements tool result coalescing to reduce message spam on WhatsApp. Successive tool results of the same type within 250ms are batched into a single message formatted as `[🛠️ tool] arg1, arg2`. Includes helper function `formatToolAggregate()` and debounce logic in the command reply handler.

## 00353 — Verbose: shorten home paths in tool meta
**SHA:** deac5ff585 · **Time:** 10:12
...
## 00354 — Verbose: slow tool batch window to 1s
**SHA:** b6b5144ddf · **Time:** 10:13
**Files changed:** src/auto-reply/command-reply.ts
**Tags:** `verbosity`, `auto-reply`, `core-feature`
...
## 00355 — Docs: note 1s tool coalescing window
**SHA:** 341ecf3bbe · **Time:** 10:19
...
## 00356 — Verbose: collapse tool meta paths by directory
**SHA:** c9b5df8184 · **Time:** 10:24
**Files changed:** src/auto-reply/command-reply.ts
...
## 00357 — Verbose: shorten meta paths when aggregating
**SHA:** b460fd61bd · **Time:** 10:26
**Files changed:** src/auto-reply/command-reply.ts
**Tags:** `verbosity`, `auto-reply`, `refactor`
...
## 00358 — Refactor: extract tool meta formatter + debouncer
**SHA:** 597e7e6f13 · **Time:** 10:30
**Files changed:** src/auto-reply/command-reply.ts
**Tags:** `refactor`
...
## 00359 — Chore: satisfy lint after tool-meta refactor
**SHA:** e34d0d69aa · **Time:** 10:42
**Files changed:** src/auto-reply/command-reply.ts
**Tags:** `linting`
...
## 00360 — Web: simplify logout message
**SHA:** 62c54cd47c · **Time:** 11:04
...
## 00361 — Tau RPC: wait for agent_end when tools run
**SHA:** 8220b11770 · **Time:** 11:29
...
## 00362 — Pi: resume Tau sessions with --continue
**SHA:** cc596ef011 · **Time:** 11:33
...
## 00363 — Tau RPC: resolve on agent_end or exit
**SHA:** 3958450223 · **Time:** 11:34
...
## 00364 — Pi: stream assistant text during RPC runs
**SHA:** 9253702966 · **Time:** 11:50
...
## 00365 — Pi: stream tool results faster (0.5s, flush after 5)
**SHA:** 8f99b13305 · **Time:** 12:08
...
## 00366 — Add /restart WhatsApp command to restart warelay
**SHA:** 0824873ffb · **Time:** 12:14
**Files changed:** src/auto-reply/command-reply.ts, src/index.core.test.ts
...
## 00367 — Docs: document /restart WhatsApp command
**SHA:** 273f2b61d0 · **Time:** 12:16
...
## 00368 — feat(web): add group chat mention support
**SHA:** 6afe6f4ecb · **Time:** 12:35
...
## 00369 — fix(web): detect self number mentions in group chats
**SHA:** 7ea43b0145 · **Time:** 12:43
**Files changed:** src/web/web.ts, src/index.core.test.ts
**Tags:** `bugfix`
...
## 00370 — logging: route console output into pino
**SHA:** 4c3635a7c0 · **Time:** 13:07
...
## 00371 — fix(web): allow group replies past allowFrom
**SHA:** 8204351d67 · **Time:** 13:08
**Files changed:** src/web/web.ts, src/index.core.test.ts
**Tags:** `bugfix`, `ux`
...
## 00372 — changelog: note logging capture and verbose trace
**SHA:** 47d0b6fc14 · **Time:** 13:09
**Files changed:** CHANGELOG.md
**Tags:** `documentation`

Documents the console logging integration and verbose tracing feature in the changelog.

## 00373 — fix(web): let group pings bypass allowFrom
**SHA:** 3a782b6ace · **Time:** 13:11
**Files changed:** src/web/web.ts, src/index.core.test.ts
**Tags:** `bugfix`
...
## 00374 — test(web): ensure group messages carry sender + bypass allowFrom
**SHA:** 7be9352a3a · **Time:** 13:12
...
## 00375 — fix(web): unwrap ephemeral/view-once and keep mentions
**SHA:** f68714ec8e · **Time:** 13:15
**Files changed:** src/web/web.ts
**Tags:** `bugfix`
...
## 00376 — fix(web): annotate group replies with sender
**SHA:** edc894f6c7 · **Time:** 13:25
**Files changed:** src/web/web.ts, src/index.core.test.ts
**Tags:** `bugfix`, `ux`
...
## 00377 — Create CNAME
**SHA:** 3354a683735 · **Time:** 16:44
**Files changed:** CNAME
**Tags:** `documentation`

Creates CNAME file for domain routing, setting up DNS configuration for web access.

## 00378 — auto-reply: surface tool args from rpc start events
**SHA:** 3a8d6b80e0 · **Time:** 13:31
...
## 00379 — feat(web): prime group sessions with member roster
**SHA:** b55ac994ea · **Time:** 13:33
**Files changed:** src/web/web.ts, src/index.core.test.ts
**Tags:** `core-feature`, `ux`
...
## 00380 — auto-reply: emoji + result preview for verbose tool calls
**SHA:** cb5f1fa99d · **Time:** 13:34
**Files changed:** src/auto-reply/command-reply.ts
**Tags:** `verbosity`, `auto-reply`, `ux`
...
## 00381 — auto-reply: single emoji per verbose tool line
**SHA:** e878780808 · **Time:** 13:35
**Files changed:** src/auto-reply/command-reply.ts
**Tags:** `verbosity`, `auto-reply`

Standardizes verbose tool output to use a single emoji per tool line (🛠️) for consistent visual presentation.

## 00382 — changelog: note verbose tool emoji/previews
**SHA:** 92a0763a74 · **Time:** 13:36
**Files changed:** CHANGELOG.md
**Tags:** `documentation`

Documents the verbose tool emoji and preview feature in the changelog.

## 00383 — fix(web): surface media fetch failures
**SHA:** a321bf1a90 · **Time:** 13:47
**Files changed:** src/web/web.ts
**Tags:** `bugfix`

Improves error handling for media downloads by surfacing fetch failures to users instead of silently ignoring them.

## 00384 — fix(web): capture mentions from media captions
**SHA:** 07f323222b · **Time:** 14:13
**Files changed:** src/web/web.ts
**Tags:** `bugfix`

Fixes mention detection to recognize mentions in media message captions, not just in the main message body.

## 00385 — docs: note media-only mention fix
**SHA:** 84f8d8733e · **Time:** 14:18
**Files changed:** CHANGELOG.md
**Tags:** `documentation`

Documents the fix for mention detection in media captions.

## 00386 — chore: bump version to 1.4.0
**SHA:** 89d49cd925 · **Time:** 14:23
**Files changed:** package.json
**Tags:** `dependency`

Updates version to 1.4.0, reflecting the significant feature additions in verbose output and group chat handling.

## 00387 — fix: allow directive-only toggles inside group batches
**SHA:** 088bdb3313 · **Time:** 14:32
**Files changed:** src/auto-reply/command-reply.ts
**Tags:** `bugfix`
...
## 00388 — test: cover verbose directive in group batches
**SHA:** 7bc56d7cfe · **Time:** 14:45
**Files changed:** src/index.core.test.ts
**Tags:** `testing`
...
## 00389 — Rebrand to CLAWDIS - add docs, update README
**SHA:** a27ee2366e · **Time:** 15:45
...
## 00390 — Add backlinks to clawd.me, soul.md, steipete.me
**SHA:** 80979cf4d0 · **Time:** 15:46
...
## 00391 — auto-reply: handle group think/verbose directives
**SHA:** a155ec0599 · **Time:** 02:29
**Files changed:** src/auto-reply/command-reply.ts
**Tags:** `auto-reply`, `core-feature`

Extends auto-reply handling to properly process thinking and verbose directives in group chat contexts.

## 00392 — config: support clawdis.json path for rebranding
**SHA:** 518af0ef24 · **Time:** 14:52
...
## 00393 — fix: resolve lint errors (unused vars, imports, formatting)
**SHA:** 4a35bcec21 · **Time:** 00:36
...
## 00394 — CLI: add agent command for direct agent runs
**SHA:** 05b76281f7 · **Time:** 17:53
...
## 00395 — auto-reply: honor /new after timestamp prefixes
**SHA:** 34eb75f634 · **Time:** 17:53
**Files changed:** src/auto-reply/command-reply.ts
...
## 00396 — web: fix mentioned JID extraction typing
**SHA:** 04ce98148d · **Time:** 17:54
**Files changed:** src/web/web.ts
...
## 00397 — docs: document agent CLI and changelog
**SHA:** 9797a9993a · **Time:** 17:55
**Files changed:** README.md, CHANGELOG.md
**Tags:** `documentation`

Documents the new agent CLI command and updates changelog with recent additions.

## 00398 — branding: default to clawdis paths and launchd label
**SHA:** 916a41ed60 · **Time:** 18:01
...
## 00399 — chore: organize imports after rebrand
**SHA:** 20cb709ae3 · **Time:** 18:02
...
## 00400 — Switch to clawdis RPC mode and complete rebrand
**SHA:** b3e50cbb33 · **Time:** 17:22
