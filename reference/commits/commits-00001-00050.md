...
## 00001 — Initial commit
**SHA:** f6dd362d39 · **Date:** 2025-11-24 11:16
...
## 00002 — Add warelay CLI with Twilio webhook support
**SHA:** 16dfc1a5b9 · **Date:** 2025-11-24 11:23
...
Created the Warelay CLI application — a TypeScript-based WhatsApp message relay using the Twilio API. Includes webhook server for receiving messages, polling mode for checking messages, setup command for configuring Tailscale Funnel, and send command. Adds `package.json`, `tsconfig.json`, `.env.example`, `README.md`, and the main `cli.ts`.

## 00003 — Remove deprecated @types/json5 (json5 has built-in types)
**SHA:** 4001fb58b0 · **Date:** 2025-11-24 11:26
...
## 00004 — Improve setup: detect missing Tailscale Funnel and document requirement
**SHA:** a2b73ec571 · **Date:** 2025-11-24 11:35
...
## 00005 — Tighten types: remove anys, validate funnel status, typed exec helpers
**SHA:** 1526c238bd · **Date:** 2025-11-24 11:38
...
## 00006 — Add per-function comments and minor typing polish
**SHA:** 8874ebba55 · **Date:** 2025-11-24 11:40
**Files changed:** src/index.ts
**Tags:** `documentation`
...
## 00007 — Add 📡 emoji to README header
**SHA:** d4153daec4 · **Date:** 2025-11-24 11:41
**Files changed:** README.md
**Tags:** `naming`, `documentation`

Added a satellite dish emoji (📡) to the project's README title. A cosmetic one-line change.

## 00008 — Add guided funnel fallback: prompt to install Go/tailscaled when funnel disabled
**SHA:** b9c9339ae4 · **Date:** 2025-11-24 11:45
**Files changed:** src/index.ts
...
## 00009 — Setup prompts default to Yes for Go/tailscaled and funnel assist
**SHA:** 80c300cb67 · **Date:** 2025-11-24 11:47
**Files changed:** src/index.ts
**Tags:** `ux`
...
## 00010 — Add --verbose flag; silence webhook logs by default
**SHA:** 3198caf430 · **Date:** 2025-11-24 11:50
**Files changed:** src/index.ts
**Tags:** `verbosity`
...
## 00011 — Verbose mode now logs commands; prompts default to yes
**SHA:** 0c5f3f37b4 · **Date:** 2025-11-24 11:53
**Files changed:** src/index.ts
**Tags:** `verbosity`

Extended verbose mode to log shell commands as they execute. Also changed remaining interactive prompts to default to Yes.

## 00012 — Verbose mode now prints stdout/stderr of invoked commands
**SHA:** 7b7c148f48 · **Date:** 2025-11-24 11:54
**Files changed:** src/index.ts
**Tags:** `verbosity`
...
## 00013 — Add chalk styling and verbose command output
**SHA:** 821b7ae9b9 · **Date:** 2025-11-24 11:59
...
## 00014 — Silence dotenv tip output (quiet mode)
**SHA:** 1e00bff96a · **Date:** 2025-11-24 12:00
**Files changed:** src/index.ts
**Tags:** `verbosity`
...
## 00015 — Timeout tailscale funnel in verbose runs and surface command output
**SHA:** 1229a01767 · **Date:** 2025-11-24 12:02
**Files changed:** src/index.ts
...
## 00016 — Add -y/--yes to auto-confirm prompts; verbose keeps showing command output
**SHA:** 52b0c6252d · **Date:** 2025-11-24 12:07
**Files changed:** src/index.ts
**Tags:** `ux`, `verbosity`
...
## 00017 — Improve funnel error UX and add -y auto-confirm
**SHA:** 6c6e217f83 · **Date:** 2025-11-24 12:30
**Files changed:** src/index.ts
**Tags:** `ux`, `twilio-api`
...
## 00018 — Add TWILIO_SENDER_SID override and better funnel/setup error messages
**SHA:** e52e943317 · **Date:** 2025-11-24 12:36
**Files changed:** README.md, src/index.ts
**Tags:** `twilio-api`, `ux`
...
## 00019 — Fix Twilio sender list call (use params instead of qs)
**SHA:** eb1c4ae7cf · **Date:** 2025-11-24 12:50
**Files changed:** src/index.ts
**Tags:** `bugfix`, `twilio-api`

Fixed a bug in the Twilio API call for listing senders — was passing query string parameters incorrectly using `qs` instead of `params`. The sender list call was failing silently.

## 00020 — Tighten types for Twilio requests and sender lookup
**SHA:** 3775caa72d · **Date:** 2025-11-24 12:53
**Files changed:** src/index.ts
...
## 00021 — Support TWILIO_SENDER_SID override before sender lookup
**SHA:** 1af210988b · **Date:** 2025-11-24 12:56
**Files changed:** src/index.ts
...
## 00022 — Use Twilio SDK channelsSenders.list to discover sender
**SHA:** efe0a76703 · **Date:** 2025-11-24 12:59
**Files changed:** src/index.ts
**Tags:** `twilio-api`, `refactor`
...
## 00023 — Log incoming requests and add 404 handler for webhook server
**SHA:** f7a7b1b29e · **Date:** 2025-11-24 13:04
**Files changed:** src/index.ts
...
## 00024 — Keep setup/webhook running with waitForever and graceful SIGINT
**SHA:** fc5f37514 · **Date:** 2025-11-24 13:25
**Files changed:** src/index.ts
...
## 00025 — Run CLI via tsx (no build required); note in README
**SHA:** 5fcbd6aadc · **Date:** 2025-11-24 13:28
**Files changed:** README.md, package.json
**Tags:** `dependency`, `documentation`

Switched from requiring a TypeScript build step to running directly via `tsx` (TypeScript Execute). Updated README to reflect the simpler workflow — users no longer need to run `npm run build`.

## 00026 — Keep process alive reliably with unref interval in waitForever
**SHA:** 9bdeb723b4 · **Date:** 2025-11-24 13:36
**Files changed:** src/index.ts
**Tags:** `process-lifecycle`
...
## 00027 — Add Biome linting and improve webhook error handling
**SHA:** d8bfd6ba5e · **Date:** 2025-11-24 14:06
...
## 00028 — Fallback webhook update to incoming phone number when channels sender update fails
**SHA:** a6e6a26097 · **Date:** 2025-11-24 14:20
**Files changed:** src/index.ts
...
## 00029 — Rename setup->up (alias kept) and keep process alive
**SHA:** 4a7cfbcc7c · **Date:** 2025-11-24 14:43
**Files changed:** src/index.ts
...
## 00030 — Normalize webhook path, always log inbound, fix Twilio webhook field names, log polling tip
**SHA:** 4f32120176 · **Date:** 2025-11-24 15:28
**Files changed:** src/index.ts
...
## 00031 — Add wa alias; drop deprecated setup alias
**SHA:** d51cf21131 · **Date:** 2025-11-24 15:31
**Files changed:** package.json, src/index.ts
...
## 00032 — Update README for up/poll workflow and aliases
**SHA:** 13355b11d8 · **Date:** 2025-11-24 15:33
**Files changed:** README.md
**Tags:** `documentation`
...
## 00033 — Fix webhook update: send form fields via request; keep SDK/phone fallbacks
**SHA:** a566ba442b · **Date:** 2025-11-24 15:37
**Files changed:** src/index.ts
**Tags:** `bugfix`, `twilio-api`

Fixed the webhook URL update to send form-encoded fields correctly in the HTTP request body. Maintained the fallback chain: try SDK update → try phone number update → log error.

## 00034 — Log command execution in config-driven replies
**SHA:** 7ed49a6569 · **Date:** 2025-11-24 15:58
**Files changed:** src/index.ts
...
## 00035 — Add claude auto-reply allowlist and verbose hooks
**SHA:** 42f64279d5 · **Date:** 2025-11-24 16:00
**Files changed:** README.md, src/index.ts
**Tags:** `auto-reply`, `core-feature`

Added an allowlist mechanism for the Claude-based auto-reply feature — only phone numbers on the allowlist receive AI-generated responses. Added verbose logging hooks for the auto-reply pipeline.

## 00036 — Document config options and log auto-reply timing
**SHA:** b4a995dbe5 · **Date:** 2025-11-24 16:02
**Files changed:** README.md, src/index.ts
...
## 00037 — Add command timeout and async polling auto-replies
**SHA:** a5e2636e17 · **Date:** 2025-11-24 16:06
**Files changed:** src/index.ts
...
## 00038 — Log templated command argv and enforce timeout kill
**SHA:** 17b4c5e7e7 · **Date:** 2025-11-24 16:09
**Files changed:** src/index.ts
**Tags:** `auto-reply`, `verbosity`

Improved command logging to show the fully resolved command arguments (after template substitution). Added enforcement of the timeout — kills the child process if it exceeds the time limit.

## 00039 — Log stderr and timeout info for auto-reply commands
**SHA:** fa1b357fd6 · **Date:** 2025-11-24 16:11
**Files changed:** src/index.ts
**Tags:** `auto-reply`, `verbosity`
...
## 00040 — Simplify command log to show resolved argv only
**SHA:** 47663c38fe · **Date:** 2025-11-24 16:11
**Files changed:** src/index.ts
**Tags:** `auto-reply`, `verbosity`
...
## 00041 — Run auto-reply commands via spawn with TTY to avoid hangs
**SHA:** 2f5a0d9402 · **Date:** 2025-11-24 16:15
**Files changed:** src/index.ts
**Tags:** `auto-reply`, `process-lifecycle`
...
## 00042 — Experiment with Twilio webhook updates (no functional change yet)
**SHA:** b453e285fd · **Date:** 2025-11-24 16:32
**Files changed:** src/index.ts
**Tags:** `twilio-api`

Experimental changes to Twilio webhook update logic. No functional change — appears to be exploratory code for testing different API approaches to webhook registration.

## 00043 — Add messaging service webhook fallback; always log inbound
**SHA:** 07f0a26419 · **Date:** 2025-11-24 16:47
**Files changed:** README.md, src/index.ts
...
## 00044 — Improve Twilio webhook update flow
**SHA:** 12a3c11c6d · **Date:** 2025-11-24 16:56
**Files changed:** README.md, src/index.ts
**Tags:** `twilio-api`, `ux`
...
## 00045 — Add WhatsApp Web provider option and docs
**SHA:** 3c8a105165 · **Date:** 2025-11-24 17:21
...
## 00046 — Add vitest and unit coverage for provider helpers
**SHA:** 657188a7e2 · **Date:** 2025-11-24 17:23
...
## 00047 — Update deps to latest and align tests
**SHA:** f88b3ceb7a · **Date:** 2025-11-24 17:33
...
## 00048 — Refactor CLI into modules for web provider and utils
**SHA:** cafca5c421 · **Date:** 2025-11-24 17:43
...
## 00049 — Add utility tests for paths, prefixes, and sleep
**SHA:** 574a96050b · **Date:** 2025-11-24 17:45
...
## 00050 — Use generic phone examples in README
**SHA:** dfd764fc71 · **Date:** 2025-11-24 17:46
**Files changed:** README.md
**Tags:** `documentation`
