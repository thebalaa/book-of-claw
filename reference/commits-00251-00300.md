...
## 00252 — Update README.md
**SHA:** 537348d995 · **Time:** 18:14
...
## 00253 — Docs: link Clawd setup and current config
**SHA:** 549ad272fc · **Time:** 18:17
...
## 00254 — Fix WebSocket crash + heartbeat default 10min + docs refresh
**SHA:** 85f53a4174 · **Time:** 18:21
...
## 00255 — Add warning disclaimer to claude-config.md
**SHA:** f0a5cdc6e4 · **Time:** 18:23
...
## 00256 — Redact phone number from example config
**SHA:** 5bc151fdca · **Time:** 18:24
**Files changed:** `docs/claude-config.md`
**Tags:** `documentation`
...
## 00257 — Add Peekaboo and mcporter links to recommended tools
**SHA:** e88ff78816 · **Time:** 18:26
**Files changed:** `docs/claude-config.md`
**Tags:** `documentation`, `ux`
...
## 00258 — Fix: warelay lowercase
**SHA:** e2ccde6434 · **Time:** 18:27
**Files changed:** `docs/claude-config.md`
...
## 00259 — Docs: mention Claude Code reuses existing subscription
**SHA:** a888564251 · **Time:** 18:28
**Files changed:** `docs/claude-config.md`
**Tags:** `documentation`, `ux`
...
## 00260 — Docs: explain two-phone setup for dedicated AI number
**SHA:** e1bd9976b3 · **Time:** 18:29
**Files changed:** `docs/claude-config.md`
**Tags:** `documentation`, `ux`
...
## 00261 — Docs: new Clawd session intro with personality and powers
**SHA:** c43cdc5ac3 · **Time:** 18:32
**Files changed:** `docs/claude-config.md`
**Tags:** `documentation`, `ux`
...
## 00262 — Docs: add useful CLI tools section (spotify-player, TTS, etc.)
**SHA:** 49ada54f6d · **Time:** 18:33
**Files changed:** `docs/claude-config.md`
**Tags:** `documentation`, `ux`
...
## 00263 — Heartbeat defaults and ws guard; format
**SHA:** 9b3c4db10d · **Time:** 18:37
...
## 00264 — Add WhatsApp screenshot to claude-config.md
**SHA:** 7377c676fd · **Time:** 18:43
**Files changed:** `docs/claude-config.md`
**Tags:** `documentation`, `ux`
...
## 00265 — Add gowa WhatsApp MCP to power user add-ons
**SHA:** 8acd82aa0d · **Time:** 18:45
**Files changed:** `docs/claude-config.md`
**Tags:** `documentation`, `ux`
...
## 00266 — Docs: refresh 1.2.0 changelog; fix webhook host import
**SHA:** 0cc732dce3 · **Time:** 18:46
...
## 00268 — Add browser-tools CLI and example tweets to docs
**SHA:** f5d7057042 · **Time:** 18:59
...
## 00269 — Rename claude-config.md to clawd.md, update credits
**SHA:** 8912b3e035 · **Time:** 19:07
**Files changed:** `docs/claude-config.md` → `docs/clawd.md`, `README.md`, `CREDITS.md`
...
## 00270 — Expand heartbeat capabilities in docs
**SHA:** 8d4b31a301 · **Time:** 19:09
**Files changed:** `docs/clawd.md`
**Tags:** `documentation`, `ux`
...
## 00271 — docs: Add Twitter automation and music recognition examples
**SHA:** 8ebe72951f · **Time:** 21:00
**Files changed:** `docs/clawd.md`
**Tags:** `documentation`, `ux`
...
## 00272 — Fix broken link: claude-config.md -> clawd.md
**SHA:** f871869c79 · **Time:** 05:19
**Files changed:** `README.md`
...
## 00273 — fix(media): sniff mime and keep extensions
**SHA:** 7d6a4f5204 · **Time:** 08:07
...
## 00274 — docs: document mime-first media handling
**SHA:** f63bdda628 · **Time:** 08:07
**Files changed:** `docs/clawd.md`
**Tags:** `documentation`
...
## 00275 — chore: release 1.2.1
**SHA:** c11abc1134 · **Time:** 08:11
**Files changed:** `package.json`, `package-lock.json`
**Tags:** `bugfix`
...
## 00276 — docs: note changelog not needed for pure tests
**SHA:** 84f25953 · **Time:** 08:13
...
## 00277 — feat(heartbeat): allow manual message and dry-run for web/twilio
**SHA:** 12d7be7cad · **Time:** 08:14
...
## 00278 — chore: move heartbeat notes to unreleased 1.2.2
**SHA:** 4e3663b4d4 · **Time:** 08:14
...
## 00279 — chore: release 1.2.2
**SHA:** 5bafe9483d · **Time:** 08:17
**Files changed:** `package.json`, `package-lock.json`
**Tags:** `core-feature`
...
## 00280 — feat: same-phone mode with echo detection and configurable marker
**SHA:** d88ede92b9 · **Time:** 04:50
...
## 00281 — Add samePhoneResponsePrefix config option
**SHA:** 25ec1335 · **Time:** 05:24
**Files changed:** `src/config/config.ts`, `src/web/auto-reply.ts`
**Tags:** `core-feature`, `ux`

Adds configurable responsePrefix applied only in same-phone mode, allowing visual distinction of bot replies (e.g., "🦞") within shared chat bubbles.

---

## 00282 — Add timestampPrefix config for datetime awareness
**SHA:** 26e02a9b8b · **Time:** 05:25
**Files changed:** `src/config/config.ts`, `src/web/auto-reply.ts`
**Tags:** `core-feature`, `ux`
...
## 00283 — Generalize prefix config: messagePrefix + responsePrefix
**SHA:** 7564c4e7f4 · **Time:** 05:27
...
## 00284 — Simplify timestampPrefix: bool or timezone string, default true
**SHA:** 8d20edb028 · **Time:** 05:29
**Files changed:** `src/config/config.ts`, `src/web/auto-reply.ts`
**Tags:** `refactor`, `ux`
...
## 00285 — Skip responsePrefix for HEARTBEAT_OK responses
**SHA:** 37d8e5599 · **Time:** 06:02
...
## 00286 — Add auto-recovery from stuck WhatsApp sessions
**SHA:** 69319a0569 · **Time:** 17:53
...
## 00287 — Fix test isolation to prevent loading real user config
**SHA:** 21ba0fb8a4 · **Time:** 18:00
...
## 00288 — Increase watchdog timeout to 30 minutes
**SHA:** c5677df56e · **Time:** 18:03
**Files changed:** `src/web/auto-reply.ts`
...
## 00289 — Fix empty result JSON dump and missing heartbeat prefix
**SHA:** c5ab442f46 · **Time:** 04:29
...
## 00290 — Fix test corrupting production sessions.json
**SHA:** d107b79c63 · **Time:** 05:54
...
## 00291 — Update changelog with error message and test isolation fixes
**SHA:** 1b0e1edb08 · **Time:** 05:59
**Files changed:** `CHANGELOG.md`
**Tags:** `documentation`
...
## 00292 — web: isolate session fixtures and skip heartbeat when busy
**SHA:** 2fc3a822c8 · **Time:** 06:15
...
## 00293 — Add IPC to prevent Signal session corruption from concurrent connections
**SHA:** e86b507da7 · **Time:** 06:31
...
## 00294 — Document exclamation mark escaping workaround for Claude Code
**SHA:** e881b3c5de · **Time:** 06:52
**Files changed:** `CLAUDE.md` (symlink), `AGENTS.md`
**Tags:** `documentation`, `ux`

Creates symlink CLAUDE.md → AGENTS.md for Claude Code compatibility, documenting workaround for special character handling in agent configuration files.

---

## 00295 — Add typing indicator after IPC send
**SHA:** 96152f6577 · **Time:** 06:58
...
## 00296 — feat(web): batch inbound messages
**SHA:** 5b54d4de7a · **Time:** 07:54
...
## 00297 — chore: bump version to 1.3.0
**SHA:** 52c311e47f · **Time:** 07:54
**Files changed:** `package.json`, `package-lock.json`
**Tags:** `core-feature`
...
## 00298 — Agents: add pluggable CLIs
**SHA:** f31e89d5af · **Time:** 10:42
...
## 00299 — Tests: cover agents and fix web defaults
**SHA:** ed080ae988 · **Time:** 10:56
...
## 00300 — Changelog: note multi-agent and batching
**SHA:** 2b941ccc93 · **Time:** 10:58
**Files changed:** `CHANGELOG.md`
