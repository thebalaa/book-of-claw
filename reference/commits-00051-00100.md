# Commit Reference: 00051–00100

A plain factual summary of every commit in the OpenClaw repository, from commit 51 through commit 100.

---

## 00051 — Use lowercase warelay branding in README
**SHA:** 343ef9b63d · **Date:** 2025-11-24 17:47
**Files changed:** README.md
**Tags:** `documentation`

Changed the main heading in the README from "📡 Warelay" to "📡 warelay" for consistent lowercase branding of the product name throughout the documentation.

---

## 00052 — Add coverage run with thresholds and align tests to utils
**SHA:** 5ee4f3219d · **Date:** 2025-11-24 17:51
...
## 00053 — Add web provider inbound monitor with auto-replies
**SHA:** 9b4dceecfe · **Date:** 2025-11-24 18:33
...
## 00054 — Unify relay entrypoint and default to web when available
**SHA:** 73a3463ec8 · **Date:** 2025-11-24 23:55
**Files changed:** README.md, src/index.ts
...
## 00055 — Fix lint warnings and tighten test mocks
**SHA:** 52e0c8de25 · **Date:** 2025-11-25 00:10
...
## 00056 — Add command modules and tests; commit remaining changes
**SHA:** 938e237411 · **Date:** 2025-11-25 00:12
...
## 00057 — Fix provider-web mocks and make tests green
**SHA:** 9dd257a92d · **Date:** 2025-11-25 00:16
...
## 00058 — Add login alias for web QR and update docs/tests
**SHA:** 9595964419 · **Date:** 2025-11-25 00:19
...
## 00059 — Fix bailey auth import fallback and assert login alias
**SHA:** 3b8a31660b · **Date:** 2025-11-25 00:22
...
## 00060 — Pin to @whiskeysockets/baileys 7.0.0-rc.9 and remove auth fallback
**SHA:** 289b417c8e · **Date:** 2025-11-25 00:28
...
## 00061 — Update to latest Baileys RC and clean imports
**SHA:** 66359736d3 · **Date:** 2025-11-25 00:29
...
## 00062 — Switch to Baileys multi-file auth with latest rc
**SHA:** e12e6989c0 · **Date:** 2025-11-25 00:34
...
## 00063 — Fix web auth detection and auto-restart after 515
**SHA:** 7a5f5b8efe · **Date:** 2025-11-25 00:49
**Files changed:** src/provider-web.ts
...
## 00064 — Add lint:fix to run biome check+format
**SHA:** b76ed7e2bb · **Date:** 2025-11-25 00:50
...
## 00065 — Show provider numbers in relay banner
**SHA:** d501ac7acb · **Date:** 2025-11-25 01:35
...
## 00066 — Add claudeOutputFormat support and provider banners
**SHA:** b4e5f20cd7 · **Date:** 2025-11-25 01:36
...
## 00067 — Ignore coverage output and document Claude text mode
**SHA:** d0c9bff4ca · **Date:** 2025-11-25 01:38
...
## 00068 — Silence Baileys session logs unless verbose
**SHA:** 134edc5e49 · **Date:** 2025-11-25 01:40
**Files changed:** src/provider-web.ts
...
## 00069 — Parse Claude JSON output to return text replies
**SHA:** ba3b271c39 · **Date:** 2025-11-25 01:41
...
## 00070 — Extract auto-reply helpers into modules
**SHA:** b8b0873c1e · **Date:** 2025-11-25 02:16
...
## 00071 — Extract env + Twilio utils; shrink index
**SHA:** c71abf13a1 · **Date:** 2025-11-25 02:20
...
## 00072 — Refactor CLI and Twilio modules; add helper tests and comments
**SHA:** afdaa7ef98 · **Date:** 2025-11-25 03:11
...
## 00073 — refactor: extract twilio message utilities
**SHA:** 39b3fffe3b · **Date:** 2025-11-25 03:22
...
## 00074 — docs: clarify claude output handling
**SHA:** cac2debc34 · **Date:** 2025-11-25 03:23
**Files changed:** README.md
**Tags:** `documentation`
...
## 00075 — docs: broaden README for web provider
**SHA:** 5c5a103abb · **Date:** 2025-11-25 03:24
**Files changed:** README.md
**Tags:** `documentation`
...
## 00076 — refactor: modularize cli helpers
**SHA:** a89d7319a9 · **Date:** 2025-11-25 03:42
...
## 00077 — feat: add config validation and send dry-run
**SHA:** 8bd406f6b1 · **Date:** 2025-11-25 03:46
...
## 00078 — feat: add logger and twilio poll backoff
**SHA:** 7fa071267c · **Date:** 2025-11-25 03:48
...
## 00079 — test: add infra coverage and fix web logging
**SHA:** 594fb125e6 · **Date:** 2025-11-25 03:50
...
## 00080 — chore: harden claude json parsing and logging
**SHA:** d2abe3c459 · **Date:** 2025-11-25 03:50
**Files changed:** src/auto-reply/claude.ts, src/auto-reply/claude.test.ts
...
## 00081 — chore: route port error debug through logger
**SHA:** 1f5390ed99 · **Date:** 2025-11-25 03:51
...
## 00082 — docs: note dry-run and config validation
**SHA:** b3511e1192 · **Date:** 2025-11-25 03:52
**Files changed:** README.md
**Tags:** `documentation`
...
## 00083 — refactor: add provider barrels and webhook grouping
**SHA:** af577f07da · **Date:** 2025-11-25 03:56
...
## 00084 — feat: add dry-run options and retry helper
**SHA:** fdfb1df0de · **Date:** 2025-11-25 03:57
...
## 00085 — chore: logger cleanup and test fixes
**SHA:** d7cc94333a · **Date:** 2025-11-25 04:05
...
## 00086 — feat: add send --json, logger cleanup, and resilient Claude parsing
**SHA:** d1923e6efe · **Date:** 2025-11-25 04:08
...
## 00087 — feat: retries for webhook bring-up and send --json docs
**SHA:** 28277a298a · **Date:** 2025-11-25 04:10
...
## 00088 — chore: route exec logging through logger
**SHA:** 39cd9bde1f · **Date:** 2025-11-25 04:11
...
## 00089 — chore: align web provider logging and relay e2e
**SHA:** ca0b50d772 · **Date:** 2025-11-25 04:15
...
## 00090 — chore: finish logger sweep and add retry tests
**SHA:** ec630839a9 · **Date:** 2025-11-25 04:30
...
## 00091 — chore: remove refactor plan doc
**SHA:** 6dd0d04206 · **Date:** 2025-11-25 04:35
...
## 00092 — feat: serialize command auto-replies with queue
**SHA:** 13be898c07 · **Date:** 2025-11-25 04:40
...
## 00093 — chore: fix type regressions and helpers
**SHA:** 2aac606979 · **Date:** 2025-11-25 04:40
...
## 00094 — feat: log auto-reply body and stats for web provider
**SHA:** 3aedef4126 · **Date:** 2025-11-25 04:42
...
## 00095 — chore: add color to web auto-reply log
**SHA:** daf45190a9 · **Date:** 2025-11-25 04:42
**Files changed:** src/provider-web.ts
**Tags:** `verbosity`, `ux`
...
## 00096 — docs: expand README with Claude setup and FAQ
**SHA:** 14b3c6fba5 · **Date:** 2025-11-25 04:44
**Files changed:** README.md
**Tags:** `documentation`
...
## 00097 — docs: fix markdown escaping in README
**SHA:** 435ca06f16 · **Date:** 2025-11-25 04:45
**Files changed:** README.md
**Tags:** `documentation`
...
## 00098 — docs: add guidance to use dedicated WhatsApp account
**SHA:** df79c59c8e · **Date:** 2025-11-25 04:46
**Files changed:** README.md
**Tags:** `documentation`
...
## 00099 — ci: run vitest in workflow
**SHA:** ac2bdcbea6 · **Date:** 2025-11-25 04:48
...
## 00100 — feat: add image support across web and twilio
**SHA:** 948ff7f035 · **Date:** 2025-11-25 04:58
